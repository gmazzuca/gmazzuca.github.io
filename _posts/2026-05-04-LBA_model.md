...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/lba_model_1_or_2.png" class="img-fluid rounded z-depth-1" alt="Graph depicting the LBA Model race to threshold" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/accuracy_bigger.png" class="img-fluid rounded z-depth-1" alt="Histogram of empirical vs simulated data under accuracy condition" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/speed_bigger.png" class="img-fluid rounded z-depth-1" alt="Histogram of empirical vs simulated data under speed condition" %}
    </div>
</div>
<div class="caption">
